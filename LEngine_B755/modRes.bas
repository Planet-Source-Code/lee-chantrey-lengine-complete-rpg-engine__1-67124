...
Public Sub TitleBar(bValue As Boolean)

   ' Set WS_CAPTION On or Off as requested.
   Call FlipBit(WS_CAPTION, bValue)
...
Private Function FlipBit(ByVal Bit As Long, ByVal Value As Boolean) As Boolean
   ...
   End If
   Call SetWindowLong(frmMain.hWnd, -16, nStyle)
   Call Redraw
   
   ' Return success code.
   FlipBit = (nStyle = GetWindowLong(m_hWnd, -16))
End Function
